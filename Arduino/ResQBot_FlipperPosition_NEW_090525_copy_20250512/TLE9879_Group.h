...
// 0x11: CHECKSUCCESS
#define CHECKSUCCESS 0x1100

// 0x1111: SUCCESS
#define SUCCESS 0x1111

/**
 * 0x55: readHallPattern
 * @author Beatrix Dietl
 */
#define READHALLPATTERN 0x5500
...
public:
    ...
    void testBlinky();
   /**
    * readHallPattern functionality
    * @author Beatrix Dietl
    */
    uint16_t readHallPattern(uint8_t boardnr = ALL_BOARDS);
    void readHallPatterns(uint16_t* buffer);
...
public:
   ...
   /**
    * readHallPattern functionality, parameter 0x55
    * @author Beatrix Dietl
    */
    uint16_t readHallPattern();
