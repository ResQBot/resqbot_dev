#ifndef ARM_TELEOP__ARM_CONTROLLER_HPP_
#define ARM_TELEOP__ARM_CONTROLLER_HPP_
...
namespace arm_teleop
{
  class ArmController : public controller_interface::ControllerInterface
  {
    ...
    protected:
      ...
      rclcpp::Subscription<sensor_msgs::msg::Joy>::SharedPtr arm_sub_;
      bool new_msg_ = false;
...
#endif  // ARM_TELEOP__ARM_CONTROLLER_HPP_
