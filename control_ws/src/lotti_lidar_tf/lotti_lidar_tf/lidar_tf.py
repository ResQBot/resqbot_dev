...
class StaticFramePublisher(Node):
    ...
    The transforms are published periodically using a timer to avoid getting lost.
    """

    def __init__(self):
        super().__init__('static_robot_tf')

        self.tf_broadcaster = TransformBroadcaster(self)

        # Publish transforms constantly using a timer
        self.timer = self.create_timer(0.1, self.make_transforms)
    ...
    def make_transforms(self):
        ...
        quat = quaternion_from_euler(0.0, (-3.1416/6), 0.0)
