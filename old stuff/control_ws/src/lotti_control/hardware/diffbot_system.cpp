...
#include "lotti_control/diffbot_system.hpp"
...
namespace diffdrive_lotti{
  hardware_interface::CallbackReturn DiffDriveLotti::on_init(
    const hardware_interface::HardwareInfo & info){
      ...
      for (const hardware_interface::ComponentInfo & joint : info_.joints){
        ...
        if (joint.command_interfaces.size() != 1){
          RCLCPP_FATAL(
            rclcpp::get_logger("DiffDriveLotti"),
  ...
  std::vector<hardware_interface::StateInterface> DiffDriveLotti::export_state_interfaces(){
  ...
  std::vector<hardware_interface::CommandInterface> DiffDriveLotti::export_command_interfaces(){
  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & period){
    ...
    wheel_l_.pos = pos_prev + (wheel_l_.cmd * delta_seconds);
  ...
  hardware_interface::return_type  DiffDriveLotti::write(
    const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/){
...
PLUGINLIB_EXPORT_CLASS(
  diffdrive_lotti::DiffDriveLotti, hardware_interface::SystemInterface)