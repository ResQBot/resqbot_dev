...
class FlipperController : public controller_interface::ControllerInterface {
    ...
    protected:
        ...
        // for subscriber
        //rclcpp::Subscription<lotti2_msgs::msg::Flipper>::SharedPtr flipper_command_subscriber_;
        //lotti2_msgs::msg::Flipper flipper_msg_;
        ...
        double flipper_tor_cmd_[4];
        double flipper_pos_cmd_[4];
